...
/**
 * TODO#14
 * Utiliza esta clase para guardar en BD y comparar los passwords de forma
 * cifrada:
 * <a href=
 * "https://en.wikipedia.org/wiki/Cryptographic_hash_function#Password_verification">Password
 * verification</a>
 * Para ello modifica las partes necesarias en el código creado anteriormente en
 * UserService
 */
@Component
public class Hashing {
    ...
    public static boolean match(String raw, String hashed) {
        try {
            ...
            String hashedRaw = hash(raw, salt);
    ...
    private static String hash(String string, byte[] salt) throws ResponseStatusException {
        try {
